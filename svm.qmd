...
3. Calculate the prediction error $E_i = \text{Output of SVM on point i} - y_i$ for the first and second multiplier.
...
The Second Choice Heuristic attempts to find a second Lagrange multiplier, one that maximises the absolute value of the prediction error on the samples $i_1$ and $i_2$.
